...
class CookieSettingsFormOptInTest extends \albertborsos\ddd\tests\support\base\AbstractFormTest
{
     ...
     * @param $behavior
     */
    public function testDismissedInvalid($expectedErrorField, $session, $ads, $usageHelper, $statistics, $behavior)
    {
     ...
     * @param $behavior
     */
    public function testDismissedValid($session, $ads, $usageHelper, $statistics, $behavior)
    {
        $this->mockComponent(\albertborsos\cookieconsent\Component::STATUS_DISMISSED);
        $form = $this->mockForm([
            'options' => [
